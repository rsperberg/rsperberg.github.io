...
<em>[[webpack](https://webpack.github.io/docs/what-is-webpack.html "link to webpack documentation") is a module bundler. [It] takes modules with dependencies and generates static assets representing those modules.]>/
...
A robust & optimized ES3-compatible polyfill for the [`String.prototype.startsWith`](http://people.mozilla.org/~jorendorff/es6-draft.html#sec-string.prototype.startswith) method in ECMAScript 6.<br />
